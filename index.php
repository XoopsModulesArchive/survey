...
$xoopsOption['template_main'] = 'survey_list.html';
$myts =& MyTextSanitizer::getInstance();

$form_handler =& xoops_getmodulehandler('form', 'survey');
$forms = $form_handler->getObjects(new Criteria('f_isactive', 1), false);

if (!count($forms) > 0) {
    redirect_header(XOOPS_URL, 3, _MA_SV_ERR_NOFORMS_EXIST);
}
elseif (count($forms) == 1) {
    header("location:form.php?id=".$forms[0]->formid);
    exit();
}
